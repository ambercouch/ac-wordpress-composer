...
class Ai1wmfe_Export_Retention extends Ai1wmve_Export_Retention_Base {
	...
	protected function get_files() {
		...
		return Ai1wmve_File_Sorter::sort(
			$backups,
			Ai1wmve_File_Sorter::by_date_desc( $this->file_date_key() )
		);
	}
	...
	protected function setup_client( $client ) {
		// Set FTP client
		if ( is_null( $client ) ) {
			$client = Ai1wmfe_FTP_Factory::create(
