...
class Ai1wmfe_Export_Incremental_Themes {

	public static function execute( $params, Ai1wmfe_FTP_Factory $ftp = null ) {

		// Set progress
		Ai1wm_Status::info( __( 'Preparing incremental theme files...', AI1WMFE_PLUGIN_NAME ) );
		...
		try {
			$ftp->download_file( ai1wm_incremental_themes_list_path( $params ), sprintf( '%s/incremental-backups/incremental.themes.list', ai1wm_archive_folder() ) );
		...
		// Set progress
		Ai1wm_Status::info( __( 'Done preparing incremental theme files.', AI1WMFE_PLUGIN_NAME ) );
